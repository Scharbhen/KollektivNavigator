...
function buildQaPrompt(question: string, context: ChatContext): string {
  ...
  return [
    ...
    "Если вопрос просит таблицу реквизитов сторон и сумму договора, верни Markdown-таблицу с колонками: Блок, Поле, Значение. Включи заказчика, исполнителя, ИНН, КПП, адреса, банковские реквизиты, подписантов и сумму договора, если эти данные есть в документе.",
