...
const steps = [
  {
    ...
    description:
      "Мы подключаем коннекторы к вашей почте (Exchange/RuPost), сетевым папкам и 1С. Вам не нужно ничего переносить — ИИ работает там, где лежат данные.",
    icon: Link2,
    number: "01",
  },
  {
    ...
    description:
      "ИИ Коллектив «прочитывает» каждый файл, связывает письма с договорами, а договоры с оплатами. Порядок наводится автоматически без участия людей.",
    icon: DatabaseZap,
    number: "02",
  },
  {
    ...
    description:
      "Сотрудники получают простой интерфейс (как в Google), где можно задавать вопросы на обычном языке и мгновенно получать точные ответы.",
    icon: LayoutTemplate,
    number: "03",
  },
];
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center max-w-3xl mx-auto mb-20">
          ...
          <p className="text-lg text-slate-400">
            Бесшовный процесс, не требующий изменения ваших бизнес-процессов.
          </p>
        </div>
