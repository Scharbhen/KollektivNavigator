...
const solutions = [
  {
    ...
    description:
      "Разворачиваем решение внутри вашего закрытого контура. Подходит для компаний, где данные, документы и история переписки не должны выходить во внешние облака.",
    icon: Server,
  ...
  },
  {
    ...
    description:
      "Подключаем кастомные коннекторы к вашим внутренним системам: ERP, CRM, СЭД, самописным базам, файловым хранилищам и внутренним API.",
    icon: Puzzle,
  ...
  },
  {
    ...
    description:
      "Быстрый старт на наших защищенных мощностях для команд, которым нужен запуск без собственной инфраструктуры на первом этапе.",
    icon: Cloud,
    color: "text-blue-400",
    bg: "bg-blue-400/10",
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center max-w-3xl mx-auto mb-16">
          ...
          <p className="text-lg text-slate-400">
            Гибкие варианты развертывания под ваши требования к безопасности,
            инфраструктуре и глубине интеграции.
          </p>
        </div>
